...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // UID of the registered user.
}
...
type ExprRequest struct {
	...
	Expr string `protobuf:"bytes,1,opt,name=expr,proto3" json:"expr,omitempty"` // Expression of the user.
	Uid  string `protobuf:"bytes,2,opt,name=uid,proto3" json:"uid,omitempty"`   // Id of the user.
}
...
func (x *ExprRequest) GetExpr() string {
	if x != nil {
		return x.Expr
	}
	return ""
...
func (x *ExprRequest) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
type ExprResponse struct {
	...
	Id         int64  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // Id of the expression.
...
func (x *ExprResponse) GetExpression() string {
	if x != nil {
		return x.Expression
	}
	return ""
...
func (x *ExprResponse) GetAnswer() string {
	if x != nil {
		return x.Answer
	}
	return ""
...
func (x *ExprResponse) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
var file_protos_proto_rawDesc = []byte{
	...
	0x43, 0x61, 0x6c, 0x63, 0x22, 0x43, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x33, 0x0a, 0x0b, 0x45, 0x78, 0x70, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12,
	0x0a, 0x04, 0x65, 0x78, 0x70, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x65, 0x78,
	0x70, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x75, 0x69, 0x64, 0x22, 0x68, 0x0a, 0x0c, 0x45, 0x78, 0x70, 0x72, 0x52, 0x65, 0x73, 0x70,
	...
	,
}
...
var file_protos_proto_goTypes = []interface{}{
	(*RegisterRequest)(nil),  // 0: Calc.RegisterRequest
	(*RegisterResponse)(nil), // 1: Calc.RegisterResponse
	(*LoginRequest)(nil),     // 2: Calc.LoginRequest
	(*LoginResponse)(nil),    // 3: Calc.LoginResponse
	(*ExprRequest)(nil),      // 4: Calc.ExprRequest
	(*ExprResponse)(nil),     // 5: Calc.ExprResponse
}
var file_protos_proto_depIdxs = []int32{
	0, // 0: Calc.Calc.Register:input_type -> Calc.RegisterRequest
	2, // 1: Calc.Calc.Login:input_type -> Calc.LoginRequest
	4, // 2: Calc.Calc.Calculate:input_type -> Calc.ExprRequest
	1, // 3: Calc.Calc.Register:output_type -> Calc.RegisterResponse
	3, // 4: Calc.Calc.Login:output_type -> Calc.LoginResponse
	5, // 5: Calc.Calc.Calculate:output_type -> Calc.ExprResponse
